...
<body>
<h4 align="center">UserName/Password is wrong! "Try Again"</h4>
			...
			<div align="center">
				<form method="post" action="Login22">
					...
					<div id="option" align="center">
						...
						<tr>
						<tr>
							<td><input type="password" id="Password" class="fadeIn third"
								name="UserPass" placeholder="Password"></td>
						</tr>
						<tr>
						<td><input type="submit" class="fadeIn fourth" value="Login"></td>
						</tr>
					</table>
					</form>
			</div>
